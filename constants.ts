...
export const SKILLS: SkillCategory[] = [
  ...
  {
    category: "Languages",
    skills: ["English (Professional)", "Arabic (Native)", "Portuguese (Fluent)"]
  }
];
